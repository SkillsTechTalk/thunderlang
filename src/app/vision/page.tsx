...
export const metadata = pageMeta({
  title: "Vision",
  description:
    "The vision behind ThunderLang, the first Intent-Oriented Programming language for the AI era, built by SkillsTech to help engineers describe, verify, and own software.",
  path: "/vision",
});
...
const beliefs = [
  ...
  },
  {
    ...
    body: "ThunderLang is not about handing control to a model. It is about giving engineers a clearer, more defensible way to express, review, and own the software they are responsible for.",
  },
];
    ...
    <>
      ...
      <Section>
        <div className="mx-auto max-w-prose space-y-6 text-lg leading-relaxed text-haze-200">
          ...
          <p>
            ThunderLang flips the order. You describe what the software should do, why
      ...
      <Section>
        <div className="mx-auto max-w-prose">
          ...
          <p className="mt-4 text-lg leading-relaxed text-haze-300">
            ThunderLang is early. It is not production-ready, it is not magic, and it
