...
export const metadata = pageMeta({
  title: "Community",
  description:
    "Get involved with Intent, an Intent-Oriented Programming language by SkillsTech. Follow along, share ideas, and help shape the language.",
  path: "/community",
});
...
const channels = [
  ...
  },
  {
    ...
    body: "Intent sits alongside OpenThunder, Repo Mastery, SkillsTech Talk, and Certified.",
    cta: "Read the vision",
    href: "/vision",
    ready: true,
  },
  ...
  return (
    <>
      <PageHero
        ...
        intro="Intent is early, which means the people who show up now have outsized influence on where it goes. Here is how to follow along and get involved."
      >
        <DraftNote>
