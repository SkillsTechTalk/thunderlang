...
export const metadata: Metadata = {
  ...
  title: {
    default: "Intent Language | Intent-Oriented Programming for the AI era",
    template: "%s | Intent Language",
  },
  ...
  applicationName: "Intent Language",
  ...
  openGraph: {
    ...
    title: "Intent Language | Intent-Oriented Programming for the AI era",
    description: siteConfig.description,
  },
  twitter: {
