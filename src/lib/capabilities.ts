// The single source of truth for what IntentLang can do TODAY. Every status label on the site
...
export const CAPABILITIES: Capability[] = [
  { key: "cli", name: "The intent CLI", status: "available", blurb: "Install @skillstech/intentlang and run check, run, test, build, scan, and more." },
  ...
  { key: "proof", name: "Proof artifacts", status: "available", blurb: "intent build emits .intent-proof.json: the source hash + every claim's status." },
  { key: "editor", name: "Editor + Language Server", status: "available", blurb: "intent lsp gives diagnostics, completion, and hover over LSP." },
  { key: "codeToIntent", name: "Code to candidate intent", status: "experimental", blurb: "intent lift infers a humble .intent draft from TypeScript/Rust/Perl; always human-reviewed." },
